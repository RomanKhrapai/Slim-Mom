      ...
      <Formik
        ...
        validate={values => {
          ...
          if (!values.name) {
            ...
            errors.name = t(
              'authentification.This field must contain more than 3 symbols'
            );
          } else if (
            ...
            errors.name = t(
              'authentification.This field must contain only letters'
            );
          }
          ...
          if (!values.password) {
            ...
            errors.password = t(
              'authentification.This field must contain more than 8 symbols'
            );
          }
          return errors;
        }}
          ...
          <form className={s.form} onSubmit={handleSubmit}>
            <div className={s.inputsContainer}>
              <div className={s.inputBox}>
                ...
                <label className={getActiveClass(values.name)} htmlFor="name">
                  {t('authentification.Name')} *
                </label>
              </div>
              <div className={s.inputBox}>
                <input
              ...
              <GoogleButton name={t('navigation.Registration')} />
            </div>
          </form>
        )}
      </Formik>
